...
int ld(double *x, double *y, double *z, double *w, int *n) {
  if (*n == 6) {
    return ld0006_(x, y, z, w, n);
  } else if (*n == 14) {
    return ld0014_(x, y, z, w, n);
  } else if (*n == 26) {
    return ld0026_(x, y, z, w, n);
  } else if (*n == 38) {
    return ld0038_(x, y, z, w, n);
  } else if (*n == 50) {
    return ld0050_(x, y, z, w, n);
  } else if (*n == 74) {
    return ld0074_(x, y, z, w, n);
  } else if (*n == 86) {
    return ld0086_(x, y, z, w, n);
  } else if (*n == 110) {
    return ld0110_(x, y, z, w, n);
  } else if (*n == 146) {
    return ld0146_(x, y, z, w, n);
  } else if (*n == 170) {
    return ld0170_(x, y, z, w, n);
  } else if (*n == 194) {
    return ld0194_(x, y, z, w, n);
  } else if (*n == 230) {
    return ld0230_(x, y, z, w, n);
  } else if (*n == 266) {
    return ld0266_(x, y, z, w, n);
  } else if (*n == 350) {
    return ld0350_(x, y, z, w, n);
  } else if (*n == 434) {
    return ld0434_(x, y, z, w, n);
  } else if (*n == 590) {
    return ld0590_(x, y, z, w, n);
  } else if (*n == 770) {
    return ld0770_(x, y, z, w, n);
  } else if (*n == 974) {
    return ld0974_(x, y, z, w, n);
  } else if (*n == 1202) {
    return ld1202_(x, y, z, w, n);
  } else if (*n == 1454) {
    return ld1454_(x, y, z, w, n);
  } else if (*n == 1730) {
    return ld1730_(x, y, z, w, n);
  } else if (*n == 2030) {
    return ld2030_(x, y, z, w, n);
  } else if (*n == 2354) {
    return ld2354_(x, y, z, w, n);
  } else if (*n == 2702) {
    return ld2702_(x, y, z, w, n);
  } else if (*n == 3074) {
    return ld3074_(x, y, z, w, n);
  } else if (*n == 3470) {
    return ld3470_(x, y, z, w, n);
  } else if (*n == 3890) {
    return ld3890_(x, y, z, w, n);
  } else if (*n == 4334) {
    return ld4334_(x, y, z, w, n);
  } else if (*n == 4802) {
    return ld4802_(x, y, z, w, n);
  } else if (*n == 5294) {
    return ld5294_(x, y, z, w, n);
  } else if (*n == 5810) {
    return ld5810_(x, y, z, w, n);
  }
}
